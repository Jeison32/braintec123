...
{
    public class TinventarioController : Controller
    {
        private readonly braintecDbContext _context;

        public TinventarioController(braintecDbContext context)
        {
            _context = context;
        }
